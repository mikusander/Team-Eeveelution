...
def run_hgb_pipeline(train_path: str, test_path: str, output_csv: str):
    ...
    models_dir = '/Users/giulia/Documents/Università/Magistrale/FDS/Kaggle/Hist Gradient Boosting - 0.8106/Models'
    encoders_dir = '/Users/giulia/Documents/Università/Magistrale/FDS/Kaggle/Hist Gradient Boosting - 0.8106/Encoders'
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(X_train_full, y_train_full)):
        ...
        model_filename = os.path.join(models_dir, f"hgb_fold_{fold+1}.joblib")
        joblib.dump(model_hgb, model_filename)
        ...
        test_preds_ensemble += model_hgb.predict_proba(X_test_final_fold)[:, 1]
